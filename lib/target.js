...
var bindings = {
  template: function(el, arr, makeRenderer){
    var callback;
    ...
    switch(templateType) {
      case "conditional":
        ...
        break;
      case "iterator":
        callback = function(scope, options, parentNodeList){
          var textNode = this;
          ...
          var nodeList = [textNode];
          nodeList.expression = "<list>";
          nodeLists.register(nodeList, null, parentNodeList || true);
  ...
  viewModel: function(attrs, scope, options){
